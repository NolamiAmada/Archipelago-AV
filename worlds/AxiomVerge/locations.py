...
axiom_verge_locations = {
    ...
    "Donut Vault": [AVLocation("Absu - Glitch the Donuts", BASE_ID+21)],
    ...
    "Telal Treasury_West": [AVLocation("Absu - Address Disruptor 1", BASE_ID+29)],
    ...
    "Ducts 2": [AVLocation("Absu - A Block too High", BASE_ID+33)],
    "Purple Diatoms 1_Upper": [AVLocation("Absu - Donut Shortcut", BASE_ID+34)],
    "Lava Secret": [AVLocation("Absu - Lava Hall", BASE_ID+35)],
    "Green Fungus 1_Upper": [AVLocation("Absu - Inconspicuous Wall", BASE_ID+36)],
    ...
    "Fungus Shrine": [AVLocation("Absu - Inertial Pulse", BASE_ID+40)],
    "Absu to Zi": [AVLocation("Absu - Spider Nest", BASE_ID+41)],
    "Steam Room 2_Upper": [AVLocation("Zi - Steam Room", BASE_ID+42)],
    "Central Access": [AVLocation("Zi - Blue Hall Ceiling", BASE_ID+43)],
    "Eye Stalk Secret 2": [AVLocation("Zi - Sucker Hall", BASE_ID+44)],
    "Arterial Access": [AVLocation("Zi - Orange Hall Ceiling", BASE_ID+45)],
    ...
    "Arterial Filtration": [AVLocation("Zi - VIP Box", BASE_ID+50)],
    "Arterial Bypass Entrance": [AVLocation("Zi - Purple Hall Ceiling", BASE_ID+51)],
    "Venous Maintenance 3": [AVLocation("Zi - Above Voranj", BASE_ID+52)],
    "Venous Maintenance Secret": [AVLocation("Zi - Voranj", BASE_ID+53)],
    "Uruku_Main": [AVLocation("Zi - Uruku", BASE_ID+54)],
    "Filtration_Upper": [AVLocation("Zi - Filter Ceiling", BASE_ID+55)],
    "Labcoat Room": [AVLocation("Zi - Labcoat", BASE_ID+56)],
