...
axiom_verge_locations = {
    ...
    "Ducts 2": [AVLocation("Absu - A Block too High", BASE_ID+33, logic=lambda state: logicfunction.drill(state) or logicfunction.trenchcoat(state) and (logicfunction.tempup(state) or logicfunction.anyglitch(state)))],
